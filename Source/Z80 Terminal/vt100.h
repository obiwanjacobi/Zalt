...
StringBuffer* VT100_ReportDeviceCode(char* buffer, uint16_t capacity, uint8_t code);
...
StringBuffer* VT100_ReportCursorPosition(char* buffer, uint16_t capacity, uint16_t row, uint16_t col);
...
StringBuffer* VT100_CursorHome(char* buffer, uint16_t capacity, uint16_t row, uint16_t col);

//#define VT100_CursorUp		"\x1b[{COUNT}A"
#define VT100_CursorUp		"\x1b[A"
// Moves the cursor up by COUNT rows; the default count is 1.
StringBuffer* VT100_CursorUp(char* buffer, uint16_t capacity, uint8_t count);


//#define VT100_CursorDown		"\x1b[{COUNT}B"
#define VT100_CursorDown		"\x1b[B"
// Moves the cursor down by COUNT rows; the default count is 1.
StringBuffer* VT100_CursorDown(char* buffer, uint16_t capacity, uint8_t count);

//#define VT100_CursorForward		"\x1b[{COUNT}C"
#define VT100_CursorForward		"\x1b[C"
// Moves the cursor forward by COUNT columns; the default count is 1.
StringBuffer* VT100_CursorForward(char* buffer, uint16_t capacity, uint8_t count);
...
StringBuffer* VT100_ForceCursorPosition(char* buffer, uint16_t capacity, uint16_t row, uint16_t col);
...
StringBuffer* VT100_ScrollScreen(char* buffer, uint16_t capacity, uint8_t start, uint8_t end);
...
StringBuffer* VT100_SetAttributeMode(void* buffer, uint16_t capacity, uint8_t value);
StringBuffer* VT100_Begin_SetAttributeMode(void* buffer, uint16_t capacity, uint8_t value);
result_t VT100_Add_SetAttributeMode(StringBuffer* buffer, uint8_t value);
result_t VT100_End_SetAttributeMode(StringBuffer* buffer);
