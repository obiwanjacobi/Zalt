...
#include "diskio_avr.h"		/* FatFs lower layer API */
#ifdef DRV_IDE
#include "ide_avr.h"	/* Header file of existing IDE control module */
#endif
#ifdef DRV_CFC
...
#ifdef DRV_IDE
	case DRV_IDE :
		return ide_disk_read(buff, sector, count);
#endif
#ifdef DRV_CFC
	case DRV_CFC :
...
#ifdef DRV_IDE
	case DRV_IDE :
		return ide_disk_write(buff, sector, count);
#endif
#ifdef DRV_CFC
	case DRV_CFC :
...
#ifdef DRV_IDE
	case DRV_IDE :
		return ide_disk_ioctl(cmd, buff);
#endif
#ifdef DRV_CFC
	case DRV_CFC :
